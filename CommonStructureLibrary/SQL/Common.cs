...
namespace CSL.SQL
{
    public static class Common
    {
        ...
        [Obsolete("This method is obsolete. You can just cast from a long to a ulong and back safely.",true)]
        public static ulong ToUlong(this long item)
        {
            return unchecked((ulong)(item - long.MinValue));
        }
        [Obsolete("This method is obsolete. You can just cast from a ulong to a long and back safely.",true)]
